...
import { getQuickTransaction } from '../../../store/quickTransaction';
import { deleteQuickTransaction } from '../../../store/quickTransaction';
...
export default function DeleteForm({ selectedRowData, onClose }: any) {
  ...
  const submitHandler = async () => {
    if (selectedRowData) {
      await dispatch(deleteQuickTransaction(selectedRowData?.id));
